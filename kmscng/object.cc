...
absl::flat_hash_map<std::wstring, std::string> BuildInfo(
  ...
  return {
      ...
      {L"CLR IsEphemeral", Uint32ToBytes(0)},
      {L"PublicKeyLength", Uint32ToBytes(details.public_key_length_in_bits)},
      {NCRYPT_LENGTH_PROPERTY, Uint32ToBytes(details.public_key_length_in_bits)},
